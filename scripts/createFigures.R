...
basesCPG = read_tsv(args[1], col_names = c("position", "base", "type", "comptage"))
basesNCPG = read_tsv(args[2], col_names = c("position", "base", "type", "comptage"))
mutsCPG = read_tsv(args[3], col_names = c("position", "mutation", "type", "comptage"))
mutsNCPG = read_tsv(args[4], col_names = c("position", "mutation", "type", "comptage"))
